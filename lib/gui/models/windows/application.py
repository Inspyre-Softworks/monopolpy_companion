...
from lib.gui.models.images.icons.main_default import icon as app_icon

# Load bytecode for button images
from lib.gui.models.images.buttons.app_win import start_new_button_img
from lib.gui.models.images.buttons.app_win import load_saved_button_img
...
def window():
    ...
    while True:
        ...
        if not opts_win_active and event == 'options_main_button':
            from lib.gui.models.windows.options import OptionsWindow
